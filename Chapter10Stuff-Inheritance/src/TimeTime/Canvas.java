...
public class Canvas {
	 ...
	 * 
	 * @param visible
	 *            true if the canvas should appear on the screen, false
	 *            otherwise
	 */
	 ...
	 * @param x
	 *            x coordinate for Image placement
	 * @param y
	 *            y coordinate for Image placement
	 ...
	 * 
	 * @param p1
	 *            is a Point from mouse click Convert to its x and y coordinates
	 *            and draw
	 */
	public void drawPoint(Point p1) {
		graphic.drawLine((int) p1.getX(), (int) p1.getY(), (int) p1.getX(),
				(int) p1.getY());
		canvas.repaint();
	}
	 ...
	 *            Point 1 clicked
	 * @param p2
	 *            Point 2 clicked Convert each "point" object to its x, y
	 *            coordinates
	 */

	public void drawLine(Point p1, Point p2) {
		graphic.drawLine((int) p1.getX(), (int) p1.getY(), (int) p2.getX(),
				(int) p2.getY());
		canvas.repaint();
	}
	 ...
	 * @param point1
	 *            : x1, y1 point2: x2, y2 point3: x3, y3
	 * 
	 */
	 ...
	 * 
	 * @param xs
	 *            array of x coordinates of polygon points
	 * @param ys
	 *            array of y coordinates of polygon points
	 * @param size
	...
	/**
	 * Pauses for a specified number of milliseconds before finishing. This
	...
	private class ShapeListener implements MouseListener {
		...
		public void mousePressed(MouseEvent event) {
			...
			// System.out.println ("Mouse Pressed at point x = " +
			// clickedPoint.getX()
			// + ", y = " + clickedPoint.getY() + ".");
			canvas.repaint();
		}
