...
public class Magpie
{
	...
	private String checkKeyResponses(String statement)
	{
		...
		else if (findKeyword(statement, "Mr. Due") >= 0)
		{
			response = "What a swell sounding teacher person!";
		}
		else if (findKeyword(statement, "egg") >= 0)
		{
			response = "Like oh my gosh! I love birds!";
		}
		else if (findKeyword(statement, "explode") >= 0)
		{
			response = "Bombs? You want them? They're your's my friend!";
		}
		else if (findKeyword(statement, "life") >= 0)
		{
			response = "Uhh...but I'm not alive or dead! *What the?!?!?*";
		}
